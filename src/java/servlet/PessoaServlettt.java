 ...
 * @author creuma
 */
public class PessoaServlettt extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            pessoa.setFkSexo(new SexoDAO().getIDSexo(request.getParameter("sexo")));
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> Primeiro Nome at " + pessoa.toString() + "</h1>");
            out.println("</body>");
            out.println("</html>");
